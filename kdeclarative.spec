...
Version  : 5.83.0
Release  : 37
URL      : https://download.kde.org/stable/frameworks/5.83/kdeclarative-5.83.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.83/kdeclarative-5.83.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.83/kdeclarative-5.83.0.tar.xz.sig
...
%prep
%setup -q -n kdeclarative-5.83.0
cd %{_builddir}/kdeclarative-5.83.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623650095
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kdeclarative/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdeclarative/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kdeclarative/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdeclarative/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kdeclarative/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kdeclarative/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kdeclarative/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kdeclarative/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kdeclarative/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdeclarative/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdeclarative/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kdeclarative-5.83.0/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/kdeclarative/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5CalendarEvents.so.5.83.0
/usr/lib64/libKF5Declarative.so.5
/usr/lib64/libKF5Declarative.so.5.83.0
/usr/lib64/libKF5QuickAddons.so.5
/usr/lib64/libKF5QuickAddons.so.5.83.0
