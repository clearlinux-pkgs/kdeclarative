...
Source0  : https://download.kde.org/stable/frameworks/6.5/kdeclarative-6.5.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.5/kdeclarative-6.5.0.tar.xz.sig
...
%setup -q -n kdeclarative-6.5.0
cd %{_builddir}/kdeclarative-6.5.0
pushd ..
cp -a kdeclarative-6.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723246290
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6CalendarEvents.so.6.5.0
...
/usr/lib64/libKF6CalendarEvents.so.6.5.0
