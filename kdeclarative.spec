...
Source0  : https://download.kde.org/stable/frameworks/5.60/kdeclarative-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/kdeclarative-5.60.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563069569
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5CalendarEvents.so.5.60.0
/usr/lib64/libKF5Declarative.so.5
/usr/lib64/libKF5Declarative.so.5.60.0
/usr/lib64/libKF5QuickAddons.so.5
/usr/lib64/libKF5QuickAddons.so.5.60.0
