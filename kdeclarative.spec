...
Source0  : https://download.kde.org/stable/frameworks/6.13/kdeclarative-6.13.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.13/kdeclarative-6.13.0.tar.xz.sig
...
%setup -q -n kdeclarative-6.13.0
cd %{_builddir}/kdeclarative-6.13.0
pushd ..
cp -a kdeclarative-6.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744662813
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6CalendarEvents.so.6.13.0
/V3/usr/lib64/libkquickcontrolsprivate.so.6.13.0
...
/V3/usr/lib64/qt6/qml/org/kde/kquickcontrols/libkquickcontrols.so
...
/usr/lib64/libKF6CalendarEvents.so.6.13.0
/usr/lib64/libkquickcontrolsprivate.so.0
/usr/lib64/libkquickcontrolsprivate.so.6.13.0
...
/usr/lib64/qt6/qml/org/kde/kquickcontrols/kde-qmlmodule.version
/usr/lib64/qt6/qml/org/kde/kquickcontrols/kquickcontrols.qmltypes
/usr/lib64/qt6/qml/org/kde/kquickcontrols/libkquickcontrols.so
...
/usr/lib64/qt6/qml/org/kde/private/kquickcontrols/kde-qmlmodule.version
/usr/lib64/qt6/qml/org/kde/private/kquickcontrols/kquickcontrolsprivate.qmltypes
