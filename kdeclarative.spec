...
Version  : 5.106.0
Release  : 60
URL      : https://download.kde.org/stable/frameworks/5.106/kdeclarative-5.106.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.106/kdeclarative-5.106.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.106/kdeclarative-5.106.0.tar.xz.sig
...
%prep
%setup -q -n kdeclarative-5.106.0
cd %{_builddir}/kdeclarative-5.106.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684882448
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdeclarative-%{version}/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdeclarative/e712eadfab0d2357c0f50f599ef35ee0d87534cb || :
...
cp %{_builddir}/kdeclarative-%{version}/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kdeclarative/3c3d7573e137d48253731c975ecf90d74cfa9efe || :
...
cp %{_builddir}/kdeclarative-%{version}/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kdeclarative/757b86330df80f81143d5916b3e92b4bcb1b1890 || :
...
cp %{_builddir}/kdeclarative-%{version}/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kdeclarative/7d9831e05094ce723947d729c2a46a09d6e90275 || :
cp %{_builddir}/kdeclarative-%{version}/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdeclarative/e458941548e0864907e654fa2e192844ae90fc32 || :
cp %{_builddir}/kdeclarative-%{version}/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdeclarative/e458941548e0864907e654fa2e192844ae90fc32 || :
...
%files bin
%defattr(-,root,root,-)
/V3/usr/bin/kpackagelauncherqml
/usr/bin/kpackagelauncherqml

%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5CalendarEvents.so
/V3/usr/lib64/libKF5Declarative.so
/V3/usr/lib64/libKF5QuickAddons.so
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5CalendarEvents.so.5
/V3/usr/lib64/libKF5CalendarEvents.so.5.106.0
/V3/usr/lib64/libKF5Declarative.so.5
/V3/usr/lib64/libKF5Declarative.so.5.106.0
/V3/usr/lib64/libKF5QuickAddons.so.5
/V3/usr/lib64/libKF5QuickAddons.so.5.106.0
/V3/usr/lib64/qt5/qml/org/kde/draganddrop/libdraganddropplugin.so
/V3/usr/lib64/qt5/qml/org/kde/kcm/libkcmcontrolsplugin.so
/V3/usr/lib64/qt5/qml/org/kde/kconfig/libkconfigplugin.so
/V3/usr/lib64/qt5/qml/org/kde/kcoreaddons/libkcoreaddonsplugin.so
/V3/usr/lib64/qt5/qml/org/kde/kio/libkio.so
/V3/usr/lib64/qt5/qml/org/kde/kquickcontrolsaddons/libkquickcontrolsaddonsplugin.so
/V3/usr/lib64/qt5/qml/org/kde/kwindowsystem/libkwindowsystem.so
/V3/usr/lib64/qt5/qml/org/kde/private/kquickcontrols/libkquickcontrolsprivateplugin.so
/usr/lib64/libKF5CalendarEvents.so.5
/usr/lib64/libKF5CalendarEvents.so.5.106.0
/usr/lib64/libKF5Declarative.so.5
/usr/lib64/libKF5Declarative.so.5.106.0
/usr/lib64/libKF5QuickAddons.so.5
/usr/lib64/libKF5QuickAddons.so.5.106.0
