...
Source0  : https://download.kde.org/stable/frameworks/5.97/kdeclarative-5.97.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.97/kdeclarative-5.97.0.tar.xz.sig
...
%prep
%setup -q -n kdeclarative-5.97.0
cd %{_builddir}/kdeclarative-5.97.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660577331
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5CalendarEvents.so.5.97.0
/usr/lib64/libKF5Declarative.so.5
/usr/lib64/libKF5Declarative.so.5.97.0
/usr/lib64/libKF5QuickAddons.so.5
/usr/lib64/libKF5QuickAddons.so.5.97.0
