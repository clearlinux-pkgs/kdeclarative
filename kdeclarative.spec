...
Source0  : https://download.kde.org/stable/frameworks/6.0/kdeclarative-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/kdeclarative-6.0.0.tar.xz.sig
...
%prep
%setup -q -n kdeclarative-6.0.0
cd %{_builddir}/kdeclarative-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711127409
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6CalendarEvents.so.6.0.0
...
/usr/lib64/libKF6CalendarEvents.so.6.0.0
