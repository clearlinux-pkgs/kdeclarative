...
Version  : 6.14.0
Release  : 93
URL      : https://download.kde.org/stable/frameworks/6.14/kdeclarative-6.14.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.14/kdeclarative-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/kdeclarative-6.14.0.tar.xz.sig
...
%setup -q -n kdeclarative-6.14.0
cd %{_builddir}/kdeclarative-6.14.0
pushd ..
cp -a kdeclarative-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747181582
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6CalendarEvents.so.6.14.0
/V3/usr/lib64/libkquickcontrolsprivate.so.6.14.0
...
/usr/lib64/libKF6CalendarEvents.so.6.14.0
/usr/lib64/libkquickcontrolsprivate.so.0
/usr/lib64/libkquickcontrolsprivate.so.6.14.0
