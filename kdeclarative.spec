...
Source0  : https://download.kde.org/stable/frameworks/5.68/kdeclarative-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/kdeclarative-5.68.0.tar.xz.sig
...
%prep
%setup -q -n kdeclarative-5.68.0
cd %{_builddir}/kdeclarative-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584323704
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdeclarative-5.68.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kdeclarative/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5CalendarEvents.so.5.68.0
/usr/lib64/libKF5Declarative.so.5
/usr/lib64/libKF5Declarative.so.5.68.0
/usr/lib64/libKF5QuickAddons.so.5
/usr/lib64/libKF5QuickAddons.so.5.68.0
